...
lpg:CreateButton("(Best Script De Choi) Zen Hub",function() loadstring(game:HttpGet('https://raw.githubusercontent.com/Kaizenofficiall/ZenHub/main/Loader'))() end)
...
lpg:CreateButton("(Only KRNL) Table Hub",function() loadstring(game:HttpGet('https://raw.githubusercontent.com/AltsegoD/scripts/egoD/tablekhoc.lua'))() end)
